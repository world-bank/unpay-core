...
2. [Sending 1,000 UNP to new wallet addresses.](#option2)
...
### Send 1,000 UNP to New Addresses

Just like setting up a standard MN. Send exactly 1,000 UNP to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 1K UNP.

The masternode private key may be an existing key from [Option 1](#option1), or a newly generated key from [Option 2](#option2). 

*Please note, the masternode priviate key is not the same as a wallet private key. Never put your wallet private key in the masternode.conf file. That is equivalent to putting your 1,000 UNP on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the unpay github repo](https://github.com/darkcoin/darkcoin/blob/master/doc/masternode_conf.md)
...
## What about the unpay.conf file?

If you are using a masternode.conf file you no longer need the unpay.conf file. The exception is if you need custom settings (thanks oblox). 

## Update unpay.conf on server

If you generated a new masternode private key, you will need to update the remote unpay.conf files.

Shut down the daemon and then edit the file.

```sudo nano .unpay/unpay.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote unpay.conf file.
