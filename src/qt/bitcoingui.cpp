...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Unpay address"));
    ...
    aboutAction->setStatusTip(tr("Show information about Unpay"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Unpay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Unpay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Unpay addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Unpay Core help message to get a list with possible Unpay command-line options"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Unpay client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Unpay client") + " " + tr("[testnet]"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Unpay network", "", count));
}
...
{
    QString strTitle = tr("Unpay"); // default title
